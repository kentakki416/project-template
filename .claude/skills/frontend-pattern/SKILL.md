...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Error boundaryがキャッチ:', error, errorInfo)
  }
...
**覚えておくこと**: モダンフロントエンドパターンは、保守可能でパフォーマンスの高いユーザーインターフェースを可能にします。プロジェクトの複雑度に合ったパターンを選択してください。
